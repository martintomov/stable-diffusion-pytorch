# model_converter.py contains the function to load and convert standard model weights for use in the pipeline

# Props to: https://github.com/kjsman/stable-diffusion-pytorch/issues/7#issuecomment-1426839447
